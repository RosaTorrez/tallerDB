  ...
  return (
    <div className="flex flex-col px-3 py-4 md:px-2 border-2 border-indigo-800 rounded-2xl md:h-screen h-auto">
      ...
      <div className="flex grow md:justify-between justify-center gap-2 space-x-2 flex-col md:space-x-0 md:space-y-2">
        <div
          className={"flex md:flex-col flex-row gap-2 h-[75vh] overflow-auto"}
        >
          <NavLinks />
        </div>
        ...
        <form className={"mt-auto"}>
          <button
            className="flex h-[48px] justify-center items-center w-full grow gap-2 font-medium md:flex-none md:justify-start md:p-2 md:px-3
